...
export const projects: Project[] = [
  {
    ...
    highlights: [
      "Built a full-stack AI stock analysis platform generating Buy/Sell/Hold recommendations using machine learning, technical indicators, market sentiment, and multi-horizon trend analysis.",
      "Developed a CatBoost-based stock direction classifier for 20-day price movement prediction achieving 59.32% accuracy, 60.46% precision, and 0.62 ROC-AUC.",
      "Implemented production inference via FastAPI and an interactive Gradio dashboard; containerized and deployed on AWS using Docker, Amazon ECR, ECS Fargate, and an Application Load Balancer.",
    ],
  },
  {
    id: "cephai",
